...
function getGSCData() {
  ...
  const siteUrl = 'https%3A%2F%2Fwedding.pl%2F';
...
function checkWork(property, startDate, endDate, searchType, dimension, arrayOfObjects) {
  console.log(property, startDate, endDate, searchType, dimension, arrayOfObjects);
};
